...
public class MainActivity extends AppCompatActivity {
    ...
    public void do_solution(View view) {
        ...
        String hsa=edtCofficientA.getText().toString();
        double a=Double.parseDouble(hsa);

        //để lấy giá trị hệ số b:
        double b=Double.parseDouble(edtCofficientB.getText().toString());
    ...
    private void updateTexts(String langCode) {
